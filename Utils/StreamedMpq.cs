...
namespace SharpWoW.Utils
{
    ...
    {
        private List<Stormlib.MPQFile> mStreamFiles = new List<Stormlib.MPQFile>();

        public StreamedMpq(List<Stormlib.MPQFile> files)
        {
            mStreamFiles = files;
            long curOffset = 0;
        ...
        public unsafe void Read<T>(ref T input) where T : struct
        {
